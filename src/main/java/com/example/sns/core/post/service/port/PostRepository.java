...
public interface PostRepository {
    ...
    List<Post> findLatestPostsByWriterAndStatus(Long writerId, PostStatus status, int limit);
    List<Post> findPostsByWriterAndStatusBeforeId(Long writerId, PostStatus status, Long lastId, int limit);
